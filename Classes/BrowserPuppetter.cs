...
{
    class BrowserPuppetter : Interfaces.Browser
    {
        ...
        // constructor
        public BrowserPuppetter(bool headless = false)
        {
            Init(headless);
        }
        public BrowserPuppetter(String login_name, String pass, bool headless = false)
        {
        ...
        async public void Init(bool headless)
        {
        ...
        async public void OpenPage(string URL)
        {
